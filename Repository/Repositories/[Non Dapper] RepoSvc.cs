...
namespace RepositoryDLL.Repositories
{

    public class [Non Dapper] RepoSvc : GetFile, ICoursSGBDRepo
    {
...
/*
        ...
        public void UpdateStudentDb(int id, StudentUpdate update_student)
        {
            using (var connection = OpenConnection())
            {
                ...
                string query = GetFileContent("RepositoryDLL.Repositories.SQL.UPDATE_STUDENT.sql");
